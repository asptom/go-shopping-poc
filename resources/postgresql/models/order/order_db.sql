-- This template is used to create the postgresql database and user for the order domain
...
DROP ROLE IF EXISTS $PSQL_ORDER_ROLE;
DROP DATABASE IF EXISTS $PSQL_ORDER_DB;

CREATE ROLE $PSQL_ORDER_ROLE WITH LOGIN PASSWORD '$PSQL_ORDER_PASSWORD';
CREATE DATABASE $PSQL_ORDER_DB OWNER $PSQL_ORDER_ROLE;