...
services-db-create: services-db-secret services-db-configmap
...
services-db-migrate: services-db-migrate-configmap
...
.PHONY: services-dbs ## Install databases for services in Kubernetes
services-dbs: services-db-create services-db-migrate
	@$(MAKE) separator
...
.PHONY: services-install ## Install only services (no DBs) in Kubernetes
services-install: services-build-docker
	@$(MAKE) separator
...
.PHONY: services-all ## Install services and databases in Kubernetes
services-all: services-dbs services-install
	@$(MAKE) separator
	@echo "Installing all services and their DBs in Kubernetes..."
